<div id="main" class="main-holder"><!-- this encompasses the entire Web site -->
	<div class="container-bg">
		<header id="header" class="header">
			<div class="container">
				...
				<?php else: /* Image logo */ ?>
					<?php
						$className = ( get_theme_mod( 'logo_image_background', 1 ) ) ? ' logo_h__txt' : '';
						$className = ( get_theme_mod( 'logo_image_margin', 0 ) ) ? $className . ' logo_margin' : $className;
					?>
					<a href="<?php echo home_url(); ?>/" class="logo_h logo_h__img<?php echo $className; ?>">
	...
	<?php  if( is_front_page() ) { ?>
		<div id="slider-wrapper" class="slider">
			<div class="container">
				<div class="slider-inner clearfix"><?php get_template_part('partials/slider'); ?></div>
			</div>
		</div><!-- .slider -->
	<?php } ?>
