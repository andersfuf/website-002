...
function _register() {
     ...
     * Styles
     */
    wp_register_style( 'book-css-bootstrap', get_template_directory_uri() . '/assets/legacy/book/css/bootstrap.css' );
    wp_register_style( 'book-css-bootstrap-responsive', get_template_directory_uri() . '/assets/legacy/book/css/bootstrap-responsive.css' );
    ...
    wp_register_style( 'book-css-style', get_template_directory_uri() . '/assets/css/style.css', array(), '1.0.4' );
