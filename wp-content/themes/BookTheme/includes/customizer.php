 ...
 */
	...
	$wp_customize->add_section( 'brandcolors' , array(
	  'title'      => __('Theme Coloring','booktheme'),
	  'description' => __('Defines which colors should be used throughout the theme.', 'booktheme'),
	  'priority'   => 30,
	) );

	require get_template_directory() . '/includes/customizer/color.php';
