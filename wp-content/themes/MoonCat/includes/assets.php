...
function _register() {
     ...
     * Styles
     */
    wp_register_style( 'book-css-bootstrap', get_template_directory_uri() . '/assets/css/bootstrap.css', array(), '001' );
    ...
    wp_register_style( 'book-css-style', get_template_directory_uri() . '/assets/css/style.css', array(), '002' );
