...
//	 if($con) { echo '<h1>Session connected on MYSQL</h1>';} else { echo '<h1>MYSQL server is not connected</h1>';}
 ...
 ?> 
	...
	<table border="1em">
	<thead><tr><td>pid</td><td>pname</td><td>city</td><td>country</td></tr>
	</thead>
	<tr><td>sduhfg</td><td>Line</td><td>sduhfg</td></tr>
	<tr><td>sduhfg</td><td>Thomas</td><td>Fælledparken</td></tr>
	<tr><td>42</td><td>sduhfg</td><td>copenhagen</td></tr>
	<tr><td>45</td><td colspan="2">sduhfg</td><td>Denmark</td></tr>
	<tr><td>sduhfg</td><td>Lene</td><td>sduhfg</td></tr>
	<tr><td colspan="4">test005</td></tr>
	<tfoot><tr class="farve1"><td>test013</td><td style="color:green">test014</td><td>test015</td></tr></thead>
	</table>
